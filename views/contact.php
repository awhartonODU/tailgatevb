			...
			<nav>
				<div class="menu-main-navigation-container">
					<ul id="menu-main-navigation" class="sf-menu">
						...
						<li class="menu-item">
							<a href="taproom.html" class="sf-with-ul">Taproom</a>
							<ul class="sub-menu">
								<li>
					...
					<div id="our-hours-widget-3" class="sidebar-item widget hours">
						...
						<ul class="open-hours">
							<li>
								...
								<div class="hours-date grid2column-progression lastcolumn-progression">8:00 AM - 11:00 PM</div>
								<div class="clearfix"></div>
							</li>
							<li>
							...
							<li>
								...
								<div class="hours-date grid2column-progression lastcolumn-progression">Closed</div>
								<div class="clearfix"></div>
							</li>
						</ul>
						<div class="sidebar-divider"></div>
		...
		<div class="width-container footer-3-column">
			...
			<div id="our-hours-widget-2" class="widget hours"><h2 class="widget-title">TAPROOM HOURS</h2>			
				<ul class="open-hours">
					<li>
						<div class="date-day grid2column-progression">Monday</div>
						<div class="hours-date grid2column-progression lastcolumn-progression">1:00pm - 8:00pm</div>
						<div class="clearfix"></div>
					</li>
					<li>
						<div class="date-day grid2column-progression">Tuesday</div>
